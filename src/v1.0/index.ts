...
router.post('/registerAction', (req: express.Request, res: express.Response) => {
    DataTable.register(req.query.member_key as string, parseFloat(req.query.body_temperature as string), req.query.physical_condition as string, req.query.stifling as string, req.query.fatigue as string)
        .then(() => {
            res.json({
                success: true
            })
